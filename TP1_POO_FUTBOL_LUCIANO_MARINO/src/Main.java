...
public class Main {
    public static void main(String[] args) {
        ...
        String[] mainMenuOptions = { "Gestión de Jugadores", "Gestión de Equipos", "Simular Partido", "Jugar Torneo", "Salir" };
        ...
        do {
                ...
                do {
                    ...
                    switch (jugadorOption) {
                        case 0: // Crear Jugador
                            ...
                            if (posicionJugador == null) break;

                            Integer numeroCamisetaJugador = gestor.validarEntradaInt("Ingrese el número de camiseta del jugador:", 1, 99);
                            if (numeroCamisetaJugador == null) break;

                            Integer edadJugador = gestor.validarEntradaInt("Ingrese la edad del jugador:", 18, 40);
                            if (edadJugador == null) break;
                            ...
                            if (equipoBuscar != null) {
                                if (equipoBuscar.obtenerJugadores().isEmpty()) {
                                    ...
                                    if (jugadorBuscar != null) {
                                        String infoJugador = String.format("Nombre: %s\nPosición: %s\nNúmero de Camiseta: %d\nEdad: %d",
                                                jugadorBuscar.getNombre(),
                                                jugadorBuscar.getPosicion(),
                                                jugadorBuscar.getNumeroCamiseta(),
                                                jugadorBuscar.getEdad());
            ...
            case 2: // Simular Partido
                ...
                gestor.jugarPartido(equipo1, equipo2, "amistoso"); // Partido Amistoso
                break;
